...
#define USB_OTG_DEV ((USB_Type *)g_usbdev_bus[busid].reg_base)
...
static void __chipidea_bus_reset(USB_Type *ptr)
{
...
static void chipidea_init(USB_Type *ptr)
{
    /* Reset controller */
...
static void chipidea_deinit(USB_Type *ptr)
{
    /* Stop */
 ...
 *---------------------------------------------------------------------
 */
static void __chipidea_edpt_open(USB_Type *ptr, uint8_t ep_addr, uint8_t ep_type)
{
...
static void chipidea_edpt_xfer(USB_Type *ptr, uint8_t ep_idx)
{
...
static void chipidea_edpt_stall(USB_Type *ptr, uint8_t ep_addr)
{
    uint8_t const epnum = ep_addr & 0x0f;
    uint8_t const dir = (ep_addr & 0x80) >> 7;
...
static void chipidea_edpt_clear_stall(USB_Type *ptr, uint8_t ep_addr)
{
    uint8_t const epnum = ep_addr & 0x0f;
    uint8_t const dir = (ep_addr & 0x80) >> 7;
...
static bool chipidea_edpt_check_stall(USB_Type *ptr, uint8_t ep_addr)
{
    uint8_t const epnum = ep_addr & 0x0f;
    uint8_t const dir = (ep_addr & 0x80) >> 7;
...
static void chipidea_edpt_close(USB_Type *ptr, uint8_t ep_addr)
{
    uint8_t const epnum = ep_addr & 0x0f;
    uint8_t const dir = (ep_addr & 0x80) >> 7;
